    ...
    return (
        <section className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-white capitalize text-2xl sm:text-[4dvw] text-center flex-col gap-3">
                {heading && <h1 className="font-bold leading-tight px-4 md:px-8 ">{heading}</h1>}

                {text && <h6 className="text-2xl flex justify-center items-center flex-wrap gap-3 capitalize">{p![0]} <div className="bg-white rounded-full w-2 h-2" /> {p![1]}
