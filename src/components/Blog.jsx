  ...
  return (
    <section id='blog' className="text-gray-600 body-font">
      <div className='flex w-full items-center gap-10 flex-col'>
        <h1 className='md:text-5xl text-lg font-bold'>Our <span className='pb-2 pt-1 bg-blue-500 rounded-lg px-4 md:pb-4 text-white'>Blogs</span></h1>
        ...
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              <img
                ...
                src="https://webitcoin.com.br/wp-content/uploads/2020/04/ia.jpg"
                alt="blog"
              />
              <div className="p-6">
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              <img
                className="lg:h-48 md:h-36 w-full object-cover object-center"
                src="https://tiger-sms.com/img/blog/wlBM0qehUVc.jpg"
                alt="blog"
              />
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              <img
                className="lg:h-48 md:h-36 w-full object-cover object-center"
                src="https://webitcoin.com.br/wp-content/uploads/2022/01/Capa-webitcoin-2022-01-12T151715.434.jpg"
                alt="blog"
              />
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
